...
BEGIN
    ...
    SELECT 
        ...
        COALESCE(prc.repost_count, 0)::BIGINT AS repost_count,
        EXISTS (
...
-- Create delete post function with properly qualified column references
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        WHERE p.id = p_post_id AND p.user_id = v_user_id
    ) THEN
