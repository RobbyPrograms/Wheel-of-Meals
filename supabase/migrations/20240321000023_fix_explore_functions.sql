...
DROP FUNCTION IF EXISTS get_most_liked_foods(TEXT, INTEGER);
DROP FUNCTION IF EXISTS get_top_rated_foods(NUMERIC, INTEGER);
DROP FUNCTION IF EXISTS get_healthy_foods(INTEGER);
  ...
  WITH liked_foods AS (
    ...
    WHERE 
      CASE 
        ...
        ELSE true
      END
      AND (p.is_explore = true OR f.visibility = 'public')
